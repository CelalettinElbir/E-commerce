        ...
        <div class="container">
            <div class="header__bottom--inner position__relative d-flex align-items-center">
                <div class="categories__menu ">
                    <div class="categories__menu--header bg__secondary text-white d-flex align-items-center collapsed"
                        data-bs-toggle="collapse" data-bs-target="#categoriesAccordion" aria-expanded="false">
                            ...
                            <li class="categories__menu--items">
                                ...
                                <ul class="categories__submenu border-radius-10 d-flex justify-content-between">
                                    <li class="categories__submenu--items"><a class="categories__submenu--items__text"
                                            href="shop.html"><strong>Body Parts</strong></a>
                                ...
                                <a class="categories__menu--link" href="shop.html">
                                    <svg class="categories__menu--svgicon" xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <path d="M256 480h139.31a32 32 0 0031.91-29.61L463 112" fill="none"
                                            ...
                                            stroke-width="32"></path>
                                        <path fill="none" stroke="currentColor" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-width="32" d="M368 112l16-64 47-16"></path>
                                        <path fill="none" stroke="currentColor" stroke-linecap="round"
                                            stroke-miterlimit="10" stroke-width="32" d="M224 112h256"></path>
                                    </svg> Bread &amp; Bakery
                                </a>
                            </li>
                            <li class="categories__menu--items">
                ...
                <ul class="offcanvas__menu_ul">
                    ...
                    <li class="offcanvas__menu_li">
                        ...
                        <ul class="offcanvas__sub_menu">
                            ...
                            <li class="offcanvas__sub_menu_li"><a href="{{ route('user.favorites') }}"
