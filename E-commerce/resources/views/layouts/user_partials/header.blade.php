<header class="header__section  mb-20">
            ...
            <div class="header__topbar--inner d-flex align-items-center justify-content-center">
                <ul class="header__topbar--info d-md-flex d-lg-flex">
                    ...
                    <ul class="social__share d-flex justify-content-center">
                        ...
                        <li class="social__share--list">
                            <a class="social__share--icon" target="_blank" href="https://www.n11.com/magaza/ozelciler-otomotiv">
                                <i class="fa-solid fa-shop"></i>
                                <span class="">N11</span>
                            </a>
                        </li>
                        ...
                        <li class="social__share--list">
                            <a class="social__share--icon" target="_blank" href="https://www.trendyol.com/magaza/ozelciler-otomotiv-m-757179?sst=0">
                                <i class="fa-solid fa-shop"></i>
                                <span class="">Trendyol</span>
                            </a>
                        </li>
                        <li class="social__share--list">
                            <a class="social__share--icon" target="_blank" href="{{env("hepsiburada")}}">
                        ...
                        <ul class="header__menu--wrapper d-flex">
                            ...
                            <!-- <li class="header__menu--items mega__menu--items">
                                ...
                                <ul class="header__mega--menu d-flex">
                                    ...
                                    <li class="header__mega--menu__li">
                                        <ul class="header__mega--sub__menu">
                                            <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" href="my-account.html">My
                                                    Account</a></li>
                                            <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" href="my-account-2.html">My
                                                    Account 2</a></li>
                                            <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" href="404.html">404
                                                    Page</a></li>
                                            <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" href="login.html">Login
                                                    Page</a></li>
                                            <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" href="faq.html">Faq
                                                    Page</a></li>
                                        </ul>
                                    </li>
                                    <li class="header__mega--menu__li">
                                    ...
                                    <li class="header__mega--menu__li fullscreen__style d-flex">
                                        <a class="header__mega--menu__banner display-block" href="shop.html"><img class="header__mega--menu__banner--img" src="#" alt="banner-menu">
                                            <div class="banner__content">
                                                <span class="banner__content--subtitle text__secondary mb-10">20%
                                                    off</span>
                                                <h2 class="banner__content--title"><span class="banner__content--title__inner">New</span> COLLECTION
                                                </h2>
                                        ...
                                        <a class="header__mega--menu__banner display-block" href="shop.html"><img class="header__mega--menu__banner--img" src="#" alt="banner-menu">
                                            <div class="banner__content right">
                                                ...
                                                <h2 class="banner__content--title"><span class="banner__content--title__inner"> ON </span> SALE <br>
                                                    PRODUCT</h2>
                                            </div>
                                        </a>
                                    </li>
                            ...
                            <li class="header__menu--items">
                                <a class="header__menu--link active" href="blog.html">Blog
                                    <svg class="menu__arrowdown--icon" xmlns="http://www.w3.org/2000/svg" width="12" height="7.41" viewBox="0 0 12 7.41">
                                        <path d="M16.59,8.59,12,13.17,7.41,8.59,6,10l6,6,6-6Z" transform="translate(-6 -8.59)" fill="currentColor" opacity="0.7">
                                        </path>
                                    </svg>
                ...
                <div class="categories__menu ">
                    <div class="categories__menu--header bg__secondary text-white d-flex align-items-center collapsed" data-bs-toggle="collapse" data-bs-target="#categoriesAccordion" aria-expanded="false">
                        <svg class="categories__list--icon" width="18" height="15" viewBox="0 0 18 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <rect width="13" height="1.5" fill="currentColor"></rect>
                            <rect y="4.44434" width="18" height="1.5" fill="currentColor"></rect>
                            <rect y="8.88892" width="15" height="1.5" fill="currentColor"></rect>
                            ...
                            <ul class="category__mobile--menu_ul">
                                ...
                                <li class="categories__menu--items">
                                    ...
                                    <ul class="category__sub--menu">
                                        <li class="categories__submenu--items"><a class="categories__submenu--items__text" href="shop.html">Body
                                                Parts</a>
                                            <ul class="category__sub--menu">
                                        ...
                                        <li class="categories__submenu--items"><a class="categories__submenu--items__text" href="shop.html">Interior
                                                Parts</a>
                                            <ul class="category__sub--menu">
                                        ...
                                        <li class="categories__submenu--items"><a class="categories__submenu--items__text" href="shop.html">Engine
                                                &amp; Drivetrain</a>
                                            <ul class="category__sub--menu">
                                        ...
                                        <li class="categories__submenu--items"><a class="categories__submenu--items__text" href="shop.html">Cargo
                                                Accessories</a>
                                            <ul class="category__sub--menu">
                            ...
                            <ul class="header__menu--wrapper d-flex">
                                ...
                                <!-- <li class="header__menu--items mega__menu--items">
                                    ...
                                    <ul class="header__mega--menu d-flex">
                                        <li class="header__mega--menu__li">
                                            <ul class="header__mega--sub__menu">
                                                <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" href="shop.html">Shop
                                                        Left Sidebar</a></li>
                                                <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" href="shop-right-sidebar.html">Shop Right Sidebar</a></li>
                                        ...
                                        <li class="header__mega--menu__li fullscreen__style d-flex">
                                            <a class="header__mega--menu__banner display-block" href="shop.html"><img class="header__mega--menu__banner--img" src="#" alt="banner-menu">
                                                <div class="banner__content">
                                                    <span class="banner__content--subtitle text__secondary mb-10">20%
                                                        off</span>
                                                    <h2 class="banner__content--title"><span class="banner__content--title__inner">New</span>
                                                        COLLECTION</h2>
                                                    <span class="banner__content--price">$22.99</span>
                                                </div>
                                            </a>
                                            <a class="header__mega--menu__banner display-block" href="shop.html"><img class="header__mega--menu__banner--img" src="#" alt="banner-menu">
                                                <div class="banner__content right">
                                                    <span class="banner__badge--style2">20% Off</span>
                                                    <h2 class="banner__content--title"><span class="banner__content--title__inner"> ON </span> SALE
                                                        <br> PRODUCT
                                                    </h2>
                                                </div>
                                            </a>
    ...
    <div class="offcanvas__stikcy--toolbar">
        <ul class="d-flex justify-content-between">
            ...
            <li class="offcanvas__stikcy--toolbar__list">
                <a class="offcanvas__stikcy--toolbar__btn" href="{{ route('user.favorites') }}">
                    <span class="offcanvas__stikcy--toolbar__icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class=" -heart">
                            <path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z">
                            </path>
    ...
    <div class="offCanvas__minicart">
        <div class="minicart__header ">
            <div class="minicart__header--top d-flex justify-content-between align-items-center">
                <h3 class="minicart__title"> Alışveriş Sepeti</h3>
