        ...
        <div class="main__footer">
            <div class="row ">
                        ...
                        <div class="footer__widget--inner">
                            ...
                            <ul class="social__share footer__social d-flex">
                                <li class="social__share--list">
                                    <a class="social__share--icon__style2" target="_blank" href="https://www.facebook.com/profile.php?id=100093568951131">
                                ...
                                <a class="social__share--icon__style2" target="_blank" href="{{route("whatsapp")}}">
                                ...
                                <li class="social__share--list">
                                    <a class="social__share--icon__style2" target="_blank" href="https://www.instagram.com/ozelciler_oto_michelin/">
                ...
                <div class="col-lg-3 col-md-4">
                    <div class="footer__widget">
                        <h2 class="footer__widget--title ">Hesabım <button class="footer__widget--button" aria-label="footer widget button"></button>
                            <svg class="footer__widget--title__arrowdown--icon" xmlns="http://www.w3.org/2000/svg" width="12.355" height="8.394" viewBox="0 0 10.355 6.394">
                                <path d="M15.138,8.59l-3.961,3.952L7.217,8.59,6,9.807l5.178,5.178,5.178-5.178Z" transform="translate(-6 -8.59)" fill="currentColor"></path>
                            </svg>
                        </h2>
                        <ul class="footer__widget--menu footer__widget--inner">
                            ...
                            <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="{{route('profile.edit')}}">Hesabım</a></li>
                            <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="{{route("user.cart.index")}}">Sepet</a></li>
                            <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="{{route("register")}}">Giriş Yap</a></li>
                            <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="{{route("login")}}">Kayıt Ol </a></li>
                            <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="{{route("user.payment.index")}}">Kasa</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4">
                    <div class="footer__widget">
                        <h2 class="footer__widget--title ">Kaynaklar <button class="footer__widget--button" aria-label="footer widget button"></button>
                            <svg class="footer__widget--title__arrowdown--icon" xmlns="http://www.w3.org/2000/svg" width="12.355" height="8.394" viewBox="0 0 10.355 6.394">
                                <path d="M15.138,8.59l-3.961,3.952L7.217,8.59,6,9.807l5.178,5.178,5.178-5.178Z" transform="translate(-6 -8.59)" fill="currentColor"></path>
                            </svg>
                        </h2>
        ...
        <div class="shipping__inner d-flex">
            <div class="shipping__items d-flex align-items-center">
                ...
                <div class="shipping__content">
                    <h2 class="shipping__content--title text-white h3">kargo Bedava</h2>
                    <p class="shipping__content--desc">3000 lira Üzerine Ücretsiz Teslimat </p>
                </div>
            </div>
            <div class="shipping__items d-flex align-items-center">
                <div class="shipping__icon text-white">
                ...
                <div class="shipping__content">
                    <h2 class="shipping__content--title text-white h3">7/24 Destek</h2>
                    <p class="shipping__content--desc">7/24 Saat Bize Ulaşabilirsiniz</p>
                </div>
            </div>
            <div class="shipping__items d-flex align-items-center">
                <div class="shipping__icon text-white">
                ...
                <div class="shipping__content">
                    <h2 class="shipping__content--title text-white h3">%100 Para İadesi</h2>
                    <p class="shipping__content--desc">30 Gün İçersinde İade</p>
                </div>
            </div>
            <div class="shipping__items d-flex align-items-center">
                <div class="shipping__icon text-white">
                ...
                <div class="shipping__content">
                    <h2 class="shipping__content--title text-white h3">Güvenli Ödeme</h2>
                    <p class="shipping__content--desc">Güvenli ödeme sağlıyoruz
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="footer__bottom--inenr d-flex justify-content-between align-items-center">
                <div class="footer__logo">
                    <a class="footer__logo--link" href="index.html"><img src="#" alt="logo-img"></a>
                </div>
