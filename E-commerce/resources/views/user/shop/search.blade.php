                    ...
                    <div class="shop__sidebar--widget widget__area d-none d-lg-block">
                        ...
                        <form action="{{ route('shop.index') }}" method="GET">
                            ...
                            <div class="single__widget widget__bg">
                                ...
                                <a class="widget__title h3  d-flex align-items-center justify-content-between"
                                    type="button" data-bs-toggle="collapse" data-bs-target="#brandCollapse"
                                ...
                                <div class="collapse" id="brandCollapse">
                                    ...
                                    <div class="search__filter--radio">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="size" id="size_145"
                                                value="145">
                                            <label class="form-check-label" for="size_145">145</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="size" id="size_155"
                                                value="155">
                                            <label class="form-check-label" for="size_155">155</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="size" id="size_165"
                                                value="165">
                                            <label class="form-check-label" for="size_165">165</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="size" id="size_175"
                                                value="175">
                                            <label class="form-check-label" for="size_175">175</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="size" id="size_185"
                                                value="185">
                                            <label class="form-check-label" for="size_185">185</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="size" id="size_195"
                                                value="195">
                                            <label class="form-check-label" for="size_195">195</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="size" id="size_205"
                                                value="205">
                                            <label class="form-check-label" for="size_205">205</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="size" id="size_215"
                                                value="215">
                                            <label class="form-check-label" for="size_215">215</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="size" id="size_225"
                                                value="225">
                                            <label class="form-check-label" for="size_225">225</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="size" id="size_235"
                                                value="235">
                                            <label class="form-check-label" for="size_235">235</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="size" id="size_245"
                                                value="245">
                                            <label class="form-check-label" for="size_245">245</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="size" id="size_255"
                                                value="255">
                                            <label class="form-check-label" for="size_255">255</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="size" id="size_265"
                                                value="265">
                                            <label class="form-check-label" for="size_265">265</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="size" id="size_275"
                                                value="275">
                                            <label class="form-check-label" for="size_275">275</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="size" id="size_285"
                                                value="285">
                                            <label class="form-check-label" for="size_285">285</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="size" id="size_295"
                                                value="295">
                                            <label class="form-check-label" for="size_295">295</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="size" id="size_305"
                                                value="305">
                                            <label class="form-check-label" for="size_305">305</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="size" id="size_315"
                                                value="315">
                                            <label class="form-check-label" for="size_315">315</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="size" id="size_325"
                                                value="325">
                                            <label class="form-check-label" for="size_325">325</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="size" id="size_335"
                                                value="335">
                                            <label class="form-check-label" for="size_335">335</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="size" id="size_345"
                                                value="345">
                            ...
                            <div class="single__widget widget__bg">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="aspect_ratio"
                                        id="aspect_ratio_30" value="30">
                                    <label class="form-check-label" for="aspect_ratio_30">30</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="aspect_ratio"
                                        id="aspect_ratio_35" value="35">
                                    <label class="form-check-label" for="aspect_ratio_35">35</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="aspect_ratio"
                                        id="aspect_ratio_40" value="40">
                            ...
                            <div class="single__widget widget__bg">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="rim_diameter"
                                        id="rim_diameter_13" value="13">
                                    <label class="form-check-label" for="rim_diameter_13">13</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="rim_diameter"
                                        id="rim_diameter_14" value="14">
                                    <label class="form-check-label" for="rim_diameter_14">14</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="rim_diameter"
                                        id="rim_diameter_15" value="15">
                                                        ...
                                                        <article class="product__card">
                                                            ...
                                                            <div class="product__card--content">
                                                                ...
                                                                <h3 class="product__card--title"><a
                                                                        href="{{ route('shop.show', $product->slug) }}">{{ $product->name }}
                                                                    </a>
                                                                </h3>
