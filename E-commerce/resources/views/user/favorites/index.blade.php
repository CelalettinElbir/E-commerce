    ...
    <div class="container">
        <div class="cart__section--inner">
            ...
            <div class="cart__table">
                    ...
                    <tbody class="cart__table--body">
                        ...
                        <tr class="cart__table--body__items">
                                ...
                                <div class="cart__product d-flex align-items-center">
                                    ...
                                    <div class="cart__thumbnail">
                                        <a href="product-details.html">
                                            <img class="border-radius-5" src="{{ asset('upload/products/' . $item->image) }}" alt="cart-product" width="200px">
                                        </a>
                                    </div>
                            ...
                            <td class="cart__table--body__list text-center">
                                <span class="in__stock text__secondary">Stokta var</span>
                            </td>
                            <td class="cart__table--body__list text-right">
                                <form action="{{ route('cart.add', $item->id) }}" method="POST">
                                    @csrf
                                    <button type="submit" class="wishlist__cart--btn primary__btn">Sepete Ekle</button>
                                </form>
                            </td>
                ...
                <div class="continue__shopping d-flex justify-content-end container mb-5">
