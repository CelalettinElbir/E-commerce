        ...
        <div class="main__contact--area position__relative">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6">
                            <div class="contact__form--list mb-20">
                                ...
                                <input class="contact__form--input" name="firstName" id="input1" placeholder="Adınız" type="text" value="{{ old('firstName') }}" required>
                                @error('firstName')
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="contact__form--list mb-20">
                                ...
                                <input class="contact__form--input" name="lastName" id="input2" placeholder="Soyadınız" type="text" value="{{ old('lastName') }}" required>
                                @error('lastName')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="contact__form--list mb-20">
                                ...
                                <input class="contact__form--input" name="number" id="input3" placeholder="Telefon numaranız" type="text" value="{{ old('number') }}" required>
                                @error('number')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-12">
                            <div class="contact__form--list mb-15">
                                <label class="contact__form--label" for="input5">Mesajınızı Yazın <span class="contact__form--label__star">*</span></label>
                                <textarea class="contact__form--textarea" name="message" id="input5" placeholder="Mesajınızı Yazın" required>{{ old('message') }}</textarea>
                                @error('message')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
            ...
            <div class="contact__info border-radius-5">
                <div class="contact__info--items">
                    <h3 class="contact__info--content__title text-white mb-15">İletişime Geçin</h3>
                    <div class="contact__info--items__inner d-flex aling-items-center">
                        ...
                        <div class="contact__info--content">
                            <p class="contact__info--content__desc text-white"> <a href="tel:+4222125551">+904222125551</a> </p>
                        </div>
                    </div>
                </div>
                <div class="contact__info--items">
                    <h3 class="contact__info--content__title text-white mb-15">Email Adresi</h3>
                    <div class="contact__info--items__inner d-flex">
                        ...
                        <div class="contact__info--content">
                            <p class="contact__info--content__desc text-white"> <a href="mailto:info@example.com">info@example.com</a> <br> <a href="mailto:info@example.com">otolastikozelci@gmail.com</a></p>
                        </div>
                    </div>
                </div>
                <div class="contact__info--items">
                    <h3 class="contact__info--content__title text-white mb-15">Ofis Konumu</h3>
                    <div class="contact__info--items__inner d-flex">
                        <div class="contact__info--icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="31.57" height="31.13" viewBox="0 0 31.57 31.13">
                        ...
                        <div class="contact__info--content">
                            <p class="contact__info--content__desc text-white">Özalper, Yenibahar Cd 51 a, 44100 Yeşilyurt/Malatya</p>
                        </div>
                    </div>
                </div>
                <div class="contact__info--items">
                    ...
                    <ul class="contact__info--social d-flex">
                        <li class="contact__info--social__list">
                            <a class="contact__info--social__icon" target="_blank" href="https://www.facebook.com/profile.php?id=100093568951131">
                        ...
                        <li class="contact__info--social__list">
                            <a class="contact__info--social__icon" target="_blank" href="https://www.instagram.com/ozelciler_oto_michelin/">
