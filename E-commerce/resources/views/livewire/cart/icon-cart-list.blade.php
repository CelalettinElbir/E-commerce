            ...
            <div class="minicart__product--items d-flex">
                <div class="minicart__thumb">
                    ...
                    <a href="product-details.html"><img
                        src=" {{ asset('upload/products') . '/' . $item->options['image'] }}" alt="prduct-img"></a>
                    @endif
                    ...
                    <div class="minicart__text--footer d-flex align-items-center">
                        ...
                        <div class="quantity__box minicart__quantity">
                            <button type="button" wire:click.prevent="decreaseQuantity('{{ $item->rowId }}')"
                                class="quantity__value quickview__value--quantity decrease" aria-label="quantity value"
                            ...
                            <button type="button" wire:click.prevent="increaseQuantity('{{ $item->rowId }}')"
                                class="quantity__value quickview__value--quantity increase" aria-label="quantity value"
                                value="Increase Value">+</button>
                        </div>


                        <button wire:click.prevent = "deleteItem('{{ $item->rowId }}')"
                            class="minicart__product--remove" type="button">Remove</button>
                    </div>
                </div>
            </div>
        </div>
